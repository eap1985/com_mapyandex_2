	...
	<fieldset class="adminform">
		...
		<dl class="zend_form">		
			...
			<div class="dispcoords" style="display:none;">
				...
				?>
				<div style="display:inline" class="button2-left"><div class="image"><a href="<?php echo JURI::root(true).'/index.php?option=com_mapyandex&task=dialogxajax&tmpl=component';?>" class="modal"
				rel = "{
						handler: 'iframe'
