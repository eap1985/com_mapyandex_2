CREATE TABLE IF NOT EXISTS `#__map_yandex` (
  ...
  `width_map_yandex` int(8) NOT NULL DEFAULT '600',
  `height_map_yandex` int(8) NOT NULL DEFAULT '400',
...
(11, 'Последний тест', 'map', 'publicMap', 'пр. Невский, 1', 'Привет я Карта!', '', 'Санкт-Петербург', 'пр. Невский, 1', 'Санкт-Петербург, пр. Невский, 100', 0, '2012-11-19 11:17:31', 4, 1, 39, 1, '', 500, 500, 0, 1, '', 1, 1, 1, '{"longitude_map_yandex":"Notice: Undefined variable: longitude in /var/www/jquery/data/www/37.230.112.175/joomla/administrator/components/com_mapyandex/views/map/tmpl/form.php on line 580","latitude_map_yandex":"Notice: Undefined variable: latitude in /va', '<p>пр. Невский, 1</p>', 1, 1, 14, 0, '["1","2","3","4","5"]', '', '', '', '8f2f62', '1', 0, '100', '100', '50', 0, 0, 0, '');
