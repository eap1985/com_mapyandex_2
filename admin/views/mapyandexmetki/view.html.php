...
* Foobar View
*/
class MapYandexViewMapYandexmetki extends JView
{
	/**
	...
	function display($tpl = null)
	{
		...
		JToolBarHelper::title(   JText::_( 'COM_MAPYANDEX_NEWNMARKER' ), 'mapyandexmarker' );
			...
			JToolBarHelper::addNewX('mapyandexmetki.add');
		...
		function fetchElement($id_map = null)
		{
			...
			$query = "SELECT * FROM ".$db->nameQuote('#__map_yandex'). " WHERE map_type='map'";
			$db->setQuery( $query );
