...
<div id="editcell">
	...
	<button class="addnewroute"><?php echo JText::_('COM_MAPYANDEX_ROUTE_PROCESS'); ?></button>
...
echo $pane->startPanel(JText::_('COM_MAPYANDEX_STYLE_ROUTE'), 'panel2');
...
?>
		...
		<ul class="adminformlist">
			...
			<div style="clear:both;height:100px;">
				<label id="color_route" class="hasTip" title="" for="jform_date"><?php echo JText::_('COM_MAPYANDEX_FIELD_COLOR_LABEL'); ?></label>
				<input type="text" name="color_map_route" value="<?php echo $this->foobar->color_map_route;?>" style="margin:0 0 0 50px;" />
