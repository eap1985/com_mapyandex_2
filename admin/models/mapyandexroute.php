...
*/
	...
	{	
		...
		// Store the web link table to the database
			...
			." set ".$db->nameQuote('route_map_yandex')." = '".$this->textnl($el)
			."', ".$db->nameQuote('color_map_route')." = '".$this->textnl($data['color_map_route'])
			."', ".$db->nameQuote('map_route_opacity')." = '".$this->textnl($data['jform']['map_route_opacity'])
