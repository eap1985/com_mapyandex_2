...
*/
	...
	public function getForm($data = array(), $loadData = true) 
	{
		...
		$def = json_decode($def->map_calculator_settings);	
...
*/
	...
	{	
		...
		// Store the web link table to the database
			...
			." set ".$db->nameQuote('name_map_yandex')." = '".$data['name_map_yandex']
			."', ".$db->nameQuote('city_map_yandex')." = '".$data['city_map_yandex']
			."', ".$db->nameQuote('street_map_yandex')." = '".$data['street_map_yandex']
			."', ".$db->nameQuote('full_address_map_yandex')." = '".$data['city_map_yandex']
			."', ".$db->nameQuote('map_calculator_settings')." = '".$map_calculator_settings
			."', ".$db->nameQuote('street_map_yandex')." = '".$data['street_map_yandex']
			."', ".$db->nameQuote('yandexzoom')." = '".$data['yandexzoom']
			."', ".$db->nameQuote('autozoom')." = '".$data['jform']['autozoom']
			."', ".$db->nameQuote('yandexel')." = '".$data['yandexel']
